...
const TermsPage = () => {
  return (
    <div className="container mx-auto">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to PetCare Portal.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to PetCare Portal, accessible from
            [PetCare Portal URL](PetCare Portal URL)
          </p>
        </li>
        <li>
          <p>
      ...
      <ul>
        <li>By email: info@petcare.com</li>
      </ul>
    </div>
  )
}
