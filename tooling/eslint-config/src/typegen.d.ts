...
export type ConfigNames = 'gene/eslint-comments/rules' | 'gene/formatter/setup' | 'gene/imports/rules' | 'gene/javascript/setup' | 'gene/javascript/rules' | 'gene/jsx/setup' | 'gene/jsdoc/rules' | 'gene/jsonc/setup' | 'gene/jsonc/rules' | 'gene/markdown/setup' | 'gene/markdown/processor' | 'gene/markdown/parser' | 'gene/markdown/disables' | 'gene/node/rules' | 'gene/perfectionist/setup' | 'gene/react/setup' | 'gene/react/rules' | 'gene/sort/package-json' | 'gene/stylistic/rules' | 'gene/test/setup' | 'gene/test/rules' | 'gene/toml/setup' | 'gene/toml/rules' | 'gene/regexp/rules' | 'gene/typescript/setup' | 'antfu/typescript/parser' | 'gene/typescript/rules' | 'gene/unicorn/rules' | 'gene/yaml/setup' | 'gene/yaml/rules'
